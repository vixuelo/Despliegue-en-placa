...
uint32_t * LEON3_DATA =  (uint32_t *) (0x80000000 + 0x100);
uint32_t * LEON3_CTRL =  (uint32_t *) (0x80000000 + 0x108);
uint32_t _rdtbr();
...
void leon3_uart_ctrl_rx_enable(){
	*LEON3_CTRL=*LEON3_CTRL|1;//poner a 1 el primer bit del registro de control

}
void leon3_uart_ctrl_rx_irq_enable(){
	uint32_t bit = 1<<2;

	*LEON3_CTRL=*LEON3_CTRL|bit;
